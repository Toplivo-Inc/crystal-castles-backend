...
{
  public class PrikolcGenerationTransitionRepository : IPrikolcGenerationTransitionRepository
  {
    private CastlesDbContext _dbContext;
    public PrikolcGenerationTransitionRepository(CastlesDbContext dbContext)
    {
